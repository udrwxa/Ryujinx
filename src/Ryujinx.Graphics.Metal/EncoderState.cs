...
namespace Ryujinx.Graphics.Metal
{
    ...
    enum DirtyFlags
    {
        ...
        RenderAll = RenderPipeline | DepthStencil | DepthClamp | DepthBias | CullMode | FrontFace | StencilRef | Viewports | Scissors | VertexBuffers | Uniforms | Storages | Textures | Images,
